...
{
   public class GostUtilities
    {
      public  class GostSignatureFactory : ISignatureFactory
        {
            ...
            public void GostSignatureFactory(string algorithm, AsymmetricKeyParameter privateKey, SecureRandom random)
            {
